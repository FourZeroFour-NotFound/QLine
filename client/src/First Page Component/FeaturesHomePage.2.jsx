...
import {Grid} from '@material-ui/core'; 
 ...
 export default class FeaturePage extends React.Component {
   ...
   // javascript components functionality for feature page animation where jquery functionality has been emplemented
   componentDidMount () {
        ...
        if (!inProgress){
            ...
            setTimeout(() => $('.exit').removeClass('exit'), 5000);
        ...
        setTimeout( () => goToSlide(slideElements, 2), 4000 );
        setTimeout( () => goToSlide(slideElements, 1), 12000 );

   }
 
 
    // rendering page for feature usage of the users UI experience
    render () {
        return (
        <div>
          ...
          <div>
          <nav className="menu5"  style={{backgroundColor: "transparent", position: "absolute",  marginTop: "-950px", marginLeft: "100px"}} >
